package com.mygdx.flappycat.camera;
...
public class OrthoCamera extends OrthographicCamera {
	...
	public OrthoCamera() {
		this(new VirtualViewport(flappyCat.WIDTH, flappyCat.HEIGHT));
	}
	...
	public void resize() {
		VirtualViewport virtualViewport = new VirtualViewport(flappyCat.WIDTH, flappyCat.HEIGHT);
